...
test('Calls "getItems" when refreshed', () => {
  ...
  render(
    <TodoItems getItems={getItems} items={[]} handleMarkAsComplete={() => {}}/>
  )
...
test('Renders items', () => {
  ...
  render(
    <TodoItems items={items} getItems={() => {}} handleMarkAsComplete={() => {}}/>
  )
...
test('Mark an item as completed', () => {
  ...
  render(
    <TodoItems items={items} handleMarkAsComplete={handleMarkAsComplete} getItems={() => {}}/>
  )
